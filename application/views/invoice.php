...
<div class="container-fluid">
    <table class="table-invoice center-element">
        ...
        <tr>
            <td class="cell-invoice"></td>
            <td class="cell-invoice"></td>
            <td class="cell-invoice cell-invoice-info-body cell-invoice-small-info">08/31/2016</td>
            <td class="cell-invoice cell-invoice-info-body cell-invoice-small-info">1-170102-0938-40</td>
        </tr>
        <tr>
            <td class="cell-invoice"></td>
            <td class="cell-invoice"></td>
            ...
            <td class="cell-invoice" colspan="6">
                <table class="table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>08/17/2016</td>
                            <td>2017 Oconee County GZ Sheriff's Calendar Donation</td>
                            <td>1</td>
                            <td>$50.00</td>
                            <td>$50.00</td>
                        </tr>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3" style="text-align: center">
                                Please make check payable to Oconee County Sheriff's Calendar. Thank you!
                            </td>
                            <th>Total</th>
                            <th>$50.00</th>
                        </tr>
